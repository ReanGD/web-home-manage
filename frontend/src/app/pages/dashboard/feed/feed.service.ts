  ...
  private _data = [
    {
      ...
      text: '"Vader and Me"',
      preview: 'app/feed/none_vader-and-me-preview.png',
      ...
      preview: 'app/feed/none_my-little-kitten.png',
      ...
      text: '"New York, USA"',
      preview: 'app/feed/none_new-york-location.png',
      ...
      header: 'Posted photo',
      text: '"Protein Heroes"',
      preview: 'app/feed/none_genom.png',
